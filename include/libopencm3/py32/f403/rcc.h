 ...
 *
 * @brief <b>Defined Constants and Types for the PY32F403 Reset and Clock
 * Control</b>
 *
 * @ingroup PY32F403_defines
 *
 * @version 1.0.0
 *
 * @author @htmlonly &copy; @endhtmlonly 2024
 * Tan Bin \<tarnbin at gmail dot com\>
 *
 * @date 23 July 2024
 *
...
#define RCC_AHB1ENR				MMIO32(RCC_BASE + 0x14)
...
#define RCC_CFGR1				MMIO32(RCC_BASE + 0x28)
#define RCC_AHB1RSTR				MMIO32(RCC_BASE + 0x2c)
#define RCC_AHB2RSTR				MMIO32(RCC_BASE + 0x30)
#define RCC_AHB2ENR				MMIO32(RCC_BASE + 0x34)
#define RCC_CFGR2				MMIO32(RCC_BASE + 0x38)
